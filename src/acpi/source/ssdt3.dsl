 ...
 *
 * Disassembly of ssdt3.dat, Mon Oct  5 21:31:48 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000380D (14349)
 *     Revision         0x02
 *     Checksum         0x67
 *     OEM ID           "CASPER"
 *     OEM Table ID     "ERA     "
...
DefinitionBlock ("", "SSDT", 2, "CASPER", "ERA     ", 0x00003000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.KBBC, MethodObj)    // 1 Arguments
    External (CPSC, UnknownObj)
    External (DSEN, UnknownObj)
    External (ECON, IntObj)
    External (GUAM, MethodObj)    // 1 Arguments
    External (LCDD, IntObj)
    External (OSYS, IntObj)
    External (PNHM, IntObj)
    External (S0ID, UnknownObj)

    OperationRegion (SANV, SystemMemory, 0x8CF70A98, 0x01F7)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Device (DD1F)
        {
            Method (GBTP, 0, NotSerialized)
            {
                Name (BLB0, Package (0x02)
                {
                    Package (0x0B)
                    {
                        0x08, 
                ...
                If ((LCDD == 0x15CAAE0D))
                {
                    Local0 = BLB1 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB1 */
                }
                ElseIf (((LCDD == 0x0665E509) || (LCDD == 0x068AE509)))
                {
                    Local0 = BLB2 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB2 */
                }
                ElseIf ((LCDD == 0x38EDAF06))
                {
                    Local0 = BLB3 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB3 */
                }
                ElseIf ((LCDD == 0x25E2AE0D))
                {
                    Local0 = BLB4 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB4 */
                }
                ElseIf ((LCDD == 0x0456E430))
                {
                    Local0 = BLB5 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB5 */
                }
                ElseIf ((LCDD == 0x0533E430))
                {
                    Local0 = BLB6 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB6 */
                }
                ElseIf ((LCDD == 0x04B7E430))
                {
                    Local0 = BLB7 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB7 */
                }
                ElseIf ((LCDD == 0x70ECAF06))
                {
                    Local0 = BLB8 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB8 */
                }
                ElseIf ((LCDD == 0x0590E430))
                {
                    Local0 = BLB9 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB9 */
                }
                ElseIf ((LCDD == 0x15CBAE0D))
                {
                    Local0 = BLBA /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLBA */
                }
                ElseIf ((LCDD == 0x06B9E509))
                {
                    Local0 = BLBB /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLBB */
                }
                ElseIf ((LCDD == 0x0679E509))
                {
                    Local0 = BLBC /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLBC */
                }
                ElseIf ((LCDD == 0x71ECAF06))
                {
                    Local0 = BLBD /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLBD */
                }
                ElseIf ((LCDD == 0x04D5E430))
                {
                    Local0 = BLBE /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLBE */
                }
                ElseIf ((LCDD == 0x21EDAF06))
                {
                    Local0 = BLBF /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLBF */
                }
                ElseIf ((LCDD == 0x4E51834C))
                {
                    Local0 = BLC0 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLC0 */
                }
                Else
                {
                    Local0 = BLB0 /* \_SB_.PCI0.GFX0.DD1F.GBTP.BLB0 */
                }
            ...
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                If ((OSYS >= 0x07DC))
                {
                    Name (TMP0, Buffer (0x28)
                    {
                        /* 0000 */  0x19, 0x80, 0x30, 0x8A, 0x47, 0x94, 0x5E, 0x9E,  // ..0.G.^.
                        /* 0008 */  0x75, 0xA8, 0x8C, 0xB2, 0xA3, 0xBC, 0xBA, 0xC6,  // u.......
                        /* 0010 */  0xD1, 0xD0, 0xE8, 0xDA, 0xFF, 0xE4               // ......
                    })
                    Local0 = GBTP ()
                    Local1 = DerefOf (Local0 [Zero])
                    Divide ((Local1 * 0xFF), 0x64, Local1, Local2)
                    Local2 += One
                    TMP0 [Zero] = Local2
                    ...
                    TMP0 [0x12] = Local2
                    CBLV = 0x80000064
                    BCLM = TMP0 /* \_SB_.PCI0.GFX0.DD1F._INI.TMP0 */
                }
            }
            ...
            {
                \_SB.PCI0.LPCB.EC0.KBBC (One)
            }

            Method (_PS3, 0, NotSerialized)  // _PS3: Power State 3
            {
                \_SB.PCI0.LPCB.EC0.KBBC (Zero)
            }
        }
